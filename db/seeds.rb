...
Content.create(intel1: "Intrapersonnelle", intel2: "Kinesthesique", title: 'Les 6 chapeaux de la créativité', chapter: 'Innovation', format: 'Discussion', duration: 45, description: "Quelle est la plus formidable invention de l’humanité ?
...
Content.create(intel1: "Logico-Mathématique", intel2: "Verbo-Linguistique", title: 'Conditionnements et conscience', chapter: 'Négociation', format: 'Top-down', duration: 30, description: "La plupart de nos actions se font inconsciemment et sont en réalité des réponses automatiques, stéréotypées et irréfléchies aux stimulations quotidiennes qui nous parviennent par nos sens.
...
Content.create(intel1: "Spatiale", intel2: "Intrapersonnelle", title: 'Burning Plateform', chapter: 'Management', format: 'Discussion', duration: 25, description: "Voici un petit exercice d’imagination :
...
Content.create(intel1: "Logico-Mathématique", intel2: "Spatiale", title: "Matrice d'Eisenhower", chapter: 'Management', format: 'Discussion', duration: 20, description: "« Ce qui est important est rarement urgent et ce qui est urgent rarement important » — Dwight D. Eisenhower
...
Client.create(
 name: "Patrick Birdman",
 email: "patrick.birdman@twitter.fr",
...
Client.create(
 name: "Nasser Al-Khelaïfi" ,
 email: "nasser.al-khelaifi@psg.fr",
 company: "PSG",
...
Client.create(
 name: "Santa Claus",
 email: "santa.claus@coca-cola.com",
 company: "Coca-Cola",
...
Client.create(
 ...
 email: "bernard.de-la-villardière@m6.fr",
 company: "M6 Groupe",

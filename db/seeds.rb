...
Content.create(title: "Les 6 lois de la persuasion", chapter: 'Négociation', format: 'Top-down', duration: 30, description: "De 0 à 6 ans, nous découvrons le monde qui nous entoure et nous apprenons à y vivre. Notre cerveau crée des raccourcis pour que nous puissions continuer à apprendre.
EXEMPLE
